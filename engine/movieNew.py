...
class movie(userarea):
    ...
    def __init__(self, file = None, rect = None, cursor = 0, looping = 0, endfunc = None, skippable = 0):
        #Looping movie
        ...
        #Movie file. Comression and encryption are not supported at this time
        self._file = file            
    ...
    def update(self, file = None, rect = None, cursor = None, looping = None, endfunc = None, visible = None, skippable = None):
    ...
    def play(self):
        ...
        if not self._playing:
            ...
            self._movie = pygame.movie.Movie(os.path.join(parameters.getmoviepath(), self._file))
